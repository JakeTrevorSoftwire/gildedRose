...
describe("Gilded Rose", () => {
  it("should foo", () => {
    const gildedRose = new GildedRose([makeItem("foo", 0, 0)]);
...
describe("master test", () => {
  it("When days = 2", () => {
    const items = [
      makeItem("+5 Dexterity Vest", 10, 20), //
      makeItem("Aged Brie", 2, 0), //
      makeItem("Elixir of the Mongoose", 5, 7), //
      makeItem("Sulfuras, Hand of Ragnaros", 0, 80), //
      makeItem("Sulfuras, Hand of Ragnaros", -1, 80),
      makeItem("Backstage passes to a TAFKAL80ETC concert", 15, 20),
      makeItem("Backstage passes to a TAFKAL80ETC concert", 10, 49),
      makeItem("Backstage passes to a TAFKAL80ETC concert", 5, 49),
      // this conjured item does not work properly yet
      makeItem("Conjured Mana Cake", 3, 6),
    ];
    ...
    expect(gildedRose.items[8].quality).toBe(2);
  });
  it("When days = 5", () => {
    const items = [
      makeItem("+5 Dexterity Vest", 10, 20), //
